...
#create a gui window for the calculator
root = tk.Tk()

#set the title
root.title('Ti1911-Calculator')

#Creating the frame for the calculator 

frame=tk.Frame(master=root,bg ="red",padx=10)
frame.pack()
...
#button design and functionality (only numbers no functions)
...
#clear values function and evaluate functions beign implemented for functionality
button_clear=tk.Button(master=frame,text="clear",padx=15,pady=5,width=12,command=clear_values)
